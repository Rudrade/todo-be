-- User
INSERT INTO user (id, username, password, role, email, is_active, contains_image) VALUES (UUID_TO_BIN(UUID()), 'valid-user', 'change', 'ROLE_USER', 'test@mail.com', true, false)
ON DUPLICATE KEY UPDATE id=id;

INSERT INTO user (id, username, password, role, email, is_active, contains_image) VALUES (UUID_TO_BIN(UUID()), 'second-user', 'change', 'ROLE_USER', 'test-2@mail.com', true, false)
ON DUPLICATE KEY UPDATE id=id;
